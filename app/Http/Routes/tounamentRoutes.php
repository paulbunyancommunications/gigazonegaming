...
Route::post('/manage/tournament', ['as' => 'manage.tournament.filter', 'uses' => 'Backend\Manage\TournamentsController@filter']); //no need for middleware as we return the names only
