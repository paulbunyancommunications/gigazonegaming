...
class LolTeamSignUpRequest extends Request
{
    ...
    public function messages()
    {
        $messages = [
            ...
            'email.email' => 'The team captain email address myst be a valid email address.',
        ...
        for ($i = 1; $i <= 4; $i++) {
            ...
            $messages['teammate-'.Numbers::toWord($i).'-email-address.email'] = 'The email address for team member '.Numbers::toWord($i).' must be a valid email address.';
        }
