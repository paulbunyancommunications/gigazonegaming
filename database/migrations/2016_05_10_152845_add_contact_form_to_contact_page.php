...
class AddContactFormToContactPage extends Migration
{
    ...
    public function up()
    {
        ...
        $contentString = '[contact-us new_line="," delimiter="|" questions="Please list any comments or suggestions.|textarea,Your Name|text,Your Email Address|email" inputs="your-name|name,your-email-address|email"]Have comments or questions, please let us know![/contact-us]';
