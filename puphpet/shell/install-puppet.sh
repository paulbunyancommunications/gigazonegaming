...
/opt/puppetlabs/puppet/bin/gem install deep_merge -v 1.0.1 --source http://rubygems.org --no-ri --no-rdoc
/opt/puppetlabs/puppet/bin/gem install activesupport -v 4.2.6 --source http://rubygems.org --no-ri --no-rdoc
/opt/puppetlabs/puppet/bin/gem install vine -v 0.2 --source http://rubygems.org --no-ri --no-rdoc
