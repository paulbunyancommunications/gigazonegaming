...
<div class="startForm" id="root">
    ...
    <select id="Team">
        ...
        <option  v-for="team in teams"  v-bind:t_id="team.tournament_id" v-bind:value="team.id">@{{team['name']}}</option>
    </select>
    <select id="Team-1">
    ...
    <button class="startButton" id="submit" onclick="submitCache();">Submit</button>
