...
<div class="startForm" id="root">
        ...
        <button class="startButton startButtonDisabled" id="submit" disabled onclick="submitCache();">Submit</button><br/>
        <div id="loader" class="hidden"></div><br/>
    <button id="clearCache" onclick="clearCache();">Clear Cache</button>
    <button id="getChampions" onclick="GetChampions();">Get Champions</button>
    <button id="championOverride" onclick="window.open('/app/GameDisplay/override')">Champion Override</button>
</div>
...
<div style="display: none" id="hiddenToken">{{ csrf_token() }}</div>
