...
<script type="text/javascript">
    ...
    $( document ).ready(function() {
        ...
        function showTeams(){
            var tournament1 = $("#Tournament option:selected").val();
            window.location.replace("/start?tournament="+tournament1);
            return false;
        }
    ...
    $( document ).ready(function() {
        ...
        function openTeamB(){
            var selected1 = $("#team1 option:selected").val();
            var selected2 = $("#team2 option:selected").val();
            window.open("/Team1?team1="+selected1);
            window.open("/Team2?team2="+selected2);
            return false;
        }
