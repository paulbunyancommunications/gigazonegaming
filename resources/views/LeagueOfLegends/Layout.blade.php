<!doctype html>
<html lang="{{ config('app.locale')}}" style="@yield('Color')" data-role="none">
<head>
    <meta charset="utf-8">
...
<div class="mainDiv" id="other">
    ...
    <div id="carouselControls" class="carousel slide hidden" data-ride="carousel" data-interval="false">
        ...
        <a class="carousel-control-next" onclick="setTimeout(function(){setBoxHeight();},100),$('#carouselControls').carousel('next');">
