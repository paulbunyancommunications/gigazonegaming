...
<head>
    ...
    {{--<link rel="stylesheet" href="/LeagueOfLegendsDisplay/CSS/bootstrap.min.css"/>--}}
...
<div class="mainDiv" id="other">
    <h1 class="backgroundH1">@yield('TeamName')</h1>
    <div class='borderTop'></div>
    <div class='borderTop2'></div>
    <div class='col-lg'>
        <div><div class="playerNameContainer">@yield('Player0Icon')<b class="summonerName">@yield('Player0Name')</b></div></div>
        <div class="playerBorder"><div class="playerInfo playerStatsContainer"><b class="playerMainHeading">&nbsp;&nbsp;Solo&nbsp;&nbsp;<br/></b>@yield('Player0SoloRank')<br/><b class="playerHeading">Win/Loss:</b><br/> @yield('Player0SoloWinLoss')</div><div class="playerInfo playerStatsContainer"><b class="playerMainHeading">&nbsp;&nbsp;Flex&nbsp;&nbsp;<br/></b>@yield('Player0FlexRank')<br/><b class="playerHeading">Win/Loss:</b><br/> @yield('Player0FlexWinLoss')</div></div>
        <div><div id="divA0" class="spinner-container"><div class="spinner-overlay"></div><div class="spinner-image"><img class="loadChampion" src="http://vignette4.wikia.nocookie.net/leagueoflegends/images/2/25/Azir_OriginalLoading.jpg/revision/latest?cb=20160516004231"/></div></div><div id="divB0" class="imageContainer hidden"><div class="spinner-container"><div class="spinner-overlay"></div><div class="spinner-image"><img class="loadChampion" src="http://vignette4.wikia.nocookie.net/leagueoflegends/images/2/25/Azir_OriginalLoading.jpg/revision/latest?cb=20160516004231"/></div></div></div></div>
    </div>
    <div class='col-lg'>
        <div><div class="playerNameContainer">@yield('Player1Icon')<b class="summonerName">@yield('Player1Name')</b></div></div>
        <div class="playerBorder"><div class="playerInfo playerStatsContainer"><b class="playerMainHeading">&nbsp;&nbsp;Solo&nbsp;&nbsp;<br/></b>@yield('Player1SoloRank')<br/><b class="playerHeading">Win/Loss:</b><br/> @yield('Player1SoloWinLoss')</div><div class="playerInfo playerStatsContainer"><b class="playerMainHeading">&nbsp;&nbsp;Flex&nbsp;&nbsp;<br/></b>@yield('Player1FlexRank')<br/><b class="playerHeading">Win/Loss:</b><br/> @yield('Player1FlexWinLoss')</div></div>
        <div><div id="divA1" class="spinner-container"><div class="spinner-overlay"></div><div class="spinner-image"><img class="loadChampion" src="http://vignette4.wikia.nocookie.net/leagueoflegends/images/2/25/Azir_OriginalLoading.jpg/revision/latest?cb=20160516004231"/></div></div><div id="divB1" class="imageContainer hidden"><div class="spinner-container"><div class="spinner-overlay"></div><div class="spinner-image"><img class="loadChampion" src="http://vignette4.wikia.nocookie.net/leagueoflegends/images/2/25/Azir_OriginalLoading.jpg/revision/latest?cb=20160516004231"/></div></div></div></div>
    </div>
    <div class='col-lg'>
        <div><div class="playerNameContainer">@yield('Player2Icon')<b class="summonerName">@yield('Player2Name')</b></div></div>
        <div class="playerBorder"><div class="playerInfo playerStatsContainer"><b class="playerMainHeading">&nbsp;&nbsp;Solo&nbsp;&nbsp;<br/></b>@yield('Player2SoloRank')<br/><b class="playerHeading">Win/Loss:</b><br/> @yield('Player2SoloWinLoss')</div><div class="playerInfo playerStatsContainer"><b class="playerMainHeading">&nbsp;&nbsp;Flex&nbsp;&nbsp;<br/></b>@yield('Player2FlexRank')<br/><b class="playerHeading">Win/Loss:</b><br/> @yield('Player2FlexWinLoss')</div></div>
        <div><div id="divA2" class="spinner-container"><div class="spinner-overlay"></div><div class="spinner-image"><img class="loadChampion" src="http://vignette4.wikia.nocookie.net/leagueoflegends/images/2/25/Azir_OriginalLoading.jpg/revision/latest?cb=20160516004231"/></div></div><div id="divB2" class="imageContainer hidden"><div class="spinner-container"><div class="spinner-overlay"></div><div class="spinner-image"><img class="loadChampion" src="http://vignette4.wikia.nocookie.net/leagueoflegends/images/2/25/Azir_OriginalLoading.jpg/revision/latest?cb=20160516004231"/></div></div></div></div>
    </div>
    <div class='col-lg'>
        <div><div class="playerNameContainer">@yield('Player3Icon')<b class="summonerName">@yield('Player3Name')</b></div></div>
        <div class="playerBorder"><div class="playerInfo playerStatsContainer"><b class="playerMainHeading">&nbsp;&nbsp;Solo&nbsp;&nbsp;<br/></b>@yield('Player3SoloRank')<br/><b class="playerHeading">Win/Loss:</b><br/> @yield('Player3SoloWinLoss')</div><div class="playerInfo playerStatsContainer"><b class="playerMainHeading">&nbsp;&nbsp;Flex&nbsp;&nbsp;<br/></b>@yield('Player3FlexRank')<br/><b class="playerHeading">Win/Loss:</b><br/> @yield('Player3FlexWinLoss')</div></div>
        <div><div id="divA3" class="spinner-container"><div class="spinner-overlay"></div><div class="spinner-image"><img class="loadChampion" src="http://vignette4.wikia.nocookie.net/leagueoflegends/images/2/25/Azir_OriginalLoading.jpg/revision/latest?cb=20160516004231"/></div></div><div id="divB3" class="imageContainer hidden"><div class="spinner-container"><div class="spinner-overlay"></div><div class="spinner-image"><img class="loadChampion" src="http://vignette4.wikia.nocookie.net/leagueoflegends/images/2/25/Azir_OriginalLoading.jpg/revision/latest?cb=20160516004231"/></div></div></div></div>
    </div>
    <div class='col-lg'>
        <div><div class="playerNameContainer">@yield('Player4Icon')<b class="summonerName">@yield('Player4Name')</b></div></div>
        <div class="playerBorder"><div class="playerInfo playerStatsContainer"><b class="playerMainHeading">&nbsp;&nbsp;Solo&nbsp;&nbsp;<br/></b>@yield('Player4SoloRank')<br/><b class="playerHeading">Win/Loss:</b><br/> @yield('Player4SoloWinLoss')</div><div class="playerInfo playerStatsContainer"><b class="playerMainHeading">&nbsp;&nbsp;Flex&nbsp;&nbsp;<br/></b>@yield('Player4FlexRank')<br/><b class="playerHeading">Win/Loss:</b><br/> @yield('Player4FlexWinLoss')</div></div>
        <div><div id="divA4" class="spinner-container"><div class="spinner-overlay"></div><div class="spinner-image"><img class="loadChampion" src="http://vignette4.wikia.nocookie.net/leagueoflegends/images/2/25/Azir_OriginalLoading.jpg/revision/latest?cb=20160516004231"/></div></div><div id="divB4" class="imageContainer hidden"><div class="spinner-container"><div class="spinner-overlay"></div><div class="spinner-image"><img class="loadChampion" src="http://vignette4.wikia.nocookie.net/leagueoflegends/images/2/25/Azir_OriginalLoading.jpg/revision/latest?cb=20160516004231"/></div></div></div></div>
    </div>
</div>
    <button onclick="setChampions();" class="btn btn-primary" style="bottom: 0; position: fixed; z-index: 300;" >Get Champions</button>
                ...
                console.log(data);
                 if(data.Champions.length != 0){
                     for(var i = 0; i < data.Champions.length; i++){
                         document.getElementById('divB' + data.Summoners[i]).innerHTML = '<img id="' + data.Summoners[i] +'" class="championImage" src="' + data.Champions[i] + '"/>';
                     }
                 }else{
                     data.log("not Happen")
                 }
