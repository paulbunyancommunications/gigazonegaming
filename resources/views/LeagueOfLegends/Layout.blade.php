...
<div class="mainDiv" id="other">
    ...
    <div class='col-lg'>
        ...
        <div id="divB0">@yield('Player0Champion')<div style="display:none;" id="divB0" class="imageContainer"><img class="championImage" src="http://vignette4.wikia.nocookie.net/leagueoflegends/images/2/25/Azir_OriginalLoading.jpg/revision/latest?cb=20160516004231"/></div></div>
    </div>
    <div class='col-lg'>
        ...
        <div id="divB1">@yield('Player1Champion')<div style="display:none;" id="divB1" class="imageContainer"><img class="championImage" src="http://vignette4.wikia.nocookie.net/leagueoflegends/images/2/25/Azir_OriginalLoading.jpg/revision/latest?cb=20160516004231"/></div></div>
    </div>
    <div class='col-lg'>
        ...
        <div id="divB2">@yield('Player2Champion')<div style="display:none;" id="divB2" class="imageContainer"><img class="championImage" src="http://vignette4.wikia.nocookie.net/leagueoflegends/images/2/25/Azir_OriginalLoading.jpg/revision/latest?cb=20160516004231"/></div></div>
    </div>
    <div class='col-lg'>
        ...
        <div id="divB3">@yield('Player3Champion')<div style="display:none;" id="divB3" class="imageContainer"><img class="championImage" src="http://vignette4.wikia.nocookie.net/leagueoflegends/images/2/25/Azir_OriginalLoading.jpg/revision/latest?cb=20160516004231"/></div></div>
    </div>
    <div class='col-lg'>
        ...
        <div id="divB4">@yield('Player4Champion')<div style="display:none;" id="divB4" class="imageContainer"><img class="championImage" src="http://vignette4.wikia.nocookie.net/leagueoflegends/images/2/25/Azir_OriginalLoading.jpg/revision/latest?cb=20160516004231"/></div></div>
    </div>
</div>
