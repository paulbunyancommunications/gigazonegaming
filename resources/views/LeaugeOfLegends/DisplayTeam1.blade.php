...
@section('content')
    ...
    <h1 style="text-align:center;font-size:3vw; color:#FBB042;"><?php echo $team; ?></h1>
...
@section('overlay')
    style="background-size:cover; box-shadow:inset 0 0 0 2000px rgba(0,0,255,0.2); width:100%; height:100%"
@stop
