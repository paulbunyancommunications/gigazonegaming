...
@section('content')
    <div class="col-xs-12">
            ...
            <div class="form-group">
                ...
                <h4 style="text-align: center;"><strong>“With great power there must also come — great responsibility.”</strong><br /><span> Amazing Fantasy #15 (August 1962) </span><br />-use the form responsibly-</h4>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-9 @if(isset($user_subject) and $user_subject=='') bg-danger @endif">
                    <input type="text" name="subject" id="subject" class="form-control" @if(isset($user_subject)) value="{{$user_subject}}"@endif>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-xs-9 @if(isset($user_message) and $user_message=='') bg-danger @endif">
                    <textarea name="message" id="message" rows="10" class="form-control" value="@if(isset($user_message)){{$user_message}}@endif"></textarea>
                </div>
            </div>
            <div class="form-group">
                <div class="col-xs-6">
