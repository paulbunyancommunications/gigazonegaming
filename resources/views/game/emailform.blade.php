    ...
    <div class="col-xs-12">
        ...
        <div class="form-group">
            ...
            <div class="col-md-offset-3 col-xs-9 @if(isset($user_message) and $user_message=='') bg-danger @endif @if(isset($preview_message)) hidden @endif">
                <textarea name="message" id="message" rows="10" class="form-control message_lock">@if(isset($user_message)){{$user_message}}@endif</textarea>
            </div>
            <div class="col-md-offset-3 col-xs-9 @if(isset($user_message) and $user_message=='') bg-danger @endif @if(!isset($preview_message)) hidden @endif">
        ...
        <div class="form-group">
            <a href="http://commonmark.org/help/" class="form-control" target="_blank">Information/help/typing references for commonmark.</a>
        </div>
