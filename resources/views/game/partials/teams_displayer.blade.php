            ...
            <div class="btn-group" role="group" aria-label="Team Actions">
                ...
                {{
                   Form::button(
                       ...
                       array('type' => 'button', 'id' => 'submit-toForm-print-'.$team["team_id"], 'class'=>'btn btn-primary btn-gz toForm','title'=>"Edit team ".$team['team_name'])
                   )
                }}
                {{
                    Form::button(
                        '<i class="fa fa-trash-o" aria-hidden="true"></i>',
                        array('type' => 'button', 'id' => 'submit-toForm-delete_soft-'.$team["team_id"], 'class'=>'btn btn-danger toForm','title'=>"Delete team ".$team['team_name'])
                    )
                }}
                {{
                    Form::button(
                        '<i class="fa fa-address-card" aria-hidden="true"></i>',
                        array('type' => 'button', 'id' => 'submit-toForm-delete_hard-'.$team["team_id"], 'class'=>'btn btn-danger toForm','title'=>"Delete team ".$team['team_name'])
                    )
                }}
                {{
                    Form::button(
