            ...
            <div class="btn-group" role="group" aria-label="Tournament Actions">
                ...
                {{
                   Form::button(
                       ...
                       array('type' => 'button', 'id' => 'submit-toForm-print-'.$tournament["tournament_id"], 'class'=>'btn btn-primary btn-gz toForm print-'.str_replace(' ', '', $tournament['tournament_name']),'title'=>"Edit tournament ".$tournament['tournament_name'])
                   )
                }}
