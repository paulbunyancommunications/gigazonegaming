    ...
    'backup' => [
        ...
        'source' => [
            ...
            'files' => [
                 ...
                 */
                'include' => [
                    // Most files in can be recovered from vcs or by build
                    // tasks, a few are custom to this site below.

                    // Include the wordpress uploads folder in backup.
                    base_path('public_html/wp-content/uploads'),
